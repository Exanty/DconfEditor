...
public class TestconfSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TestconfPackage.SYSTEM: {
				system system = (system)theEObject;
				T result = casesystem(system);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestconfPackage.NODE: {
				node node = (node)theEObject;
				T result = casenode(node);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestconfPackage.TESTER: {
				tester tester = (tester)theEObject;
				T result = casetester(tester);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestconfPackage.TESTITAV: {
				Testitav testitav = (Testitav)theEObject;
				T result = caseTestitav(testitav);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Testitav</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Testitav</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTestitav(Testitav object) {
		return null;
	}
